...
static void smemset (void volatile * buf, size_t size, int ch)
{
  char volatile * p = buf;
  while (size--)
    *p++ = (char)ch;
...
u32 t, l, r;
        ...
        outblock[7] = U8d(l);
        /* Wipe clean */
        smemset(&t, sizeof (t), 0);
        smemset(&l, sizeof (l), 0);
        smemset(&r, sizeof (r), 0);
}
...
u32 t[4], z[4], x[4];
        ...
        /* Wipe clean */
        smemset(t, sizeof(t), 0);
        smemset(x, sizeof(x), 0);
        smemset(z, sizeof(z), 0);
}
